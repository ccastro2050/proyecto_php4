<?php
/**
 * El formulario de una empresa: sirve para agregar y para editar.
 *
...
<div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
  <div>
    <h1 class="h3 mb-1"><?= $editando ? 'Editar' : 'Agregar' ?> la empresa</h1>
    <p class="text-body-secondary mb-0">
      <?= $editando ? 'El código identifica la ficha y no se cambia.' : 'El código lo escribe usted y no se podrá cambiar después.' ?>
    </p>
  </div>
  <a class="btn btn-outline-secondary" href="/empresas">Volver al listado</a>
</div>
  ...
  <div class="card-body p-4">
    <form method="post">
      ...
      <div class="mb-3">
        ...
        <div class="form-text">El nombre de la compañía.</div>
      </div>
      ...
      <?php /* ==============================================================
           LOS DOS BOTONES, QUE NO HACEN LO MISMO
             ...
             · «Guardar la ficha completa» manda todo, así que un dato
               obligatorio en blanco se rechaza (nombre).
      ...
      <?php if ($editando): ?>
        ...
        <div class="form-text mt-3">
          ...
          nombre. <strong>«Solo lo que cambié»</strong> guarda lo que
