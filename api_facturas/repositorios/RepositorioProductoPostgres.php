<?php
/**
 * RepositorioProductoPostgres — la capa de DATOS de `producto` contra PostgreSQL.
 *
 * Es el gemelo de `RepositorioProductoMariaDB`: **cumple la misma interfaz** y
...
class RepositorioProductoPostgres implements IRepositorioProducto
{
    ...
    {
        $sql = 'SELECT codigo, nombre, stock, valorunitario FROM producto ORDER BY codigo LIMIT :limite';
    ...
    public function crear(Producto $producto): bool
    {
        ...
        try {
            ...
            traducirErrorPostgres($error, 'el producto');
        }
